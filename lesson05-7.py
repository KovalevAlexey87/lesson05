...
"firm_3": 1000}, {"average_profit": 2000}] Подсказка: использовать менеджер контекста.
 """
...
with open('7.txt', 'r', encoding='cp1251') as file:
    for line in file:
...
with open('file_7.json', 'w', encoding='cp1251') as write_js:
...
firm_2 АО 20000 3000
firm_3 ПАО 30000 10000
"""
